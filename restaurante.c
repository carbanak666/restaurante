...
void criador() {
    printf("olá meu codenome e soldat, e sou iniciante na programação, espero que eu evolua muito pela frente :))\n");
}
void help() {
...
void restaurante(int escolha) {
   ...
   switch(escolha) {
            ...
            case 1:
                printf("você compro uma pizza que custa 20 reais\n");
                break;
            case 2:
                printf("você compro um hambuguer que custa 30 reais\n");
                break;
            case 3:
                printf("você compro um churrasco que custa 40 reais\n");
                break;
            case 4:
                printf("você pago um rodizio de pizza que custo 40 reais\n");
                break;
            case 5:
                printf("você pago um rodizio de hambuguer que custo 50 reais\n");
                break;
            case 6:
                printf("você pago um rodizio de churrasco que custo 80 reais\n");
                break;
            default:
